...
public class ItemServiceImplTest {
	...
	void testGetAllItems() throws OFDAException {
	...
	void testAddItem() throws OFDAException {
	...
	void testUpdateItem() throws OFDAException {
		ItemEntity testData = new ItemEntity(101L, "Burger", new CategoryEntity(100L, "fries"), 10, cost, listRest,
				new FoodCartEntity());
		ItemModel expected = new ItemModel(101L, "Burger", new CategoryModel(100L, "fries"), 10, cost, listRest1,
				new FoodCartModel());
	...
	void testRemoveItem() throws OFDAException {
		ItemEntity testData = new ItemEntity(101L, "Burger", new CategoryEntity(100L, "fries"), 10, cost, listRest,
				new FoodCartEntity());
		ItemModel expected = new ItemModel(101L, "Burger", new CategoryModel(100L, "fries"), 10, cost, listRest1,
				new FoodCartModel());
	...
	void testViewItem() throws OFDAException {
		ItemEntity testData = new ItemEntity(101L, "Burger", new CategoryEntity(100L, "fries"), 10, cost, listRest,
				new FoodCartEntity());
		ItemModel expected = new ItemModel(101L, "Burger", new CategoryModel(100L, "fries"), 10, cost, listRest1,
				new FoodCartModel());
