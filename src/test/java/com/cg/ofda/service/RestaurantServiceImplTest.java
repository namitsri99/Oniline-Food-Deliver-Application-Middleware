...
public class RestaurantServiceImplTest {
	...
	void testGetAllRestaurants() throws OFDAException {
	...
	void testAddRestaurant() throws OFDAException {
	...
	void testUpdateRestaurant() throws OFDAException {
		RestaurantEntity testData = new RestaurantEntity(101L, "Taj", address, listItem, "ramesh", "9876543210");
		RestaurantModel expected = new RestaurantModel(101L, "Taj", address, listItem1, "ramesh", "9876543210");
	...
	void testRemoveRestuarant() throws OFDAException {
		RestaurantEntity testData = new RestaurantEntity(101L, "Taj", address, listItem, "ramesh", "9876543210");
		RestaurantModel expected = new RestaurantModel(101L, "Taj", address, listItem1, "ramesh", "9876543210");
	...
	void testViewRestaurant() throws OFDAException {
		RestaurantEntity testData = new RestaurantEntity(101L, "Taj", address, listItem, "ramesh", "9876543210");
		RestaurantModel expected = new RestaurantModel(101L, "Taj", address, listItem1, "ramesh", "9876543210");
